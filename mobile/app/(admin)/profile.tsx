    ...
    <SafeAreaView style={styles.safeContainer}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerSubtitle}>Kelola akun verifikator Anda</Text>
        </View>
        ...
        <View style={styles.card}>
          <Text style={styles.cardTitle}>Detail Akun Administrator</Text>
          ...
          <View style={styles.detailRow}>
            ...
            <View style={styles.detailInfo}>
              <Text style={styles.detailLabel}>Tingkat Akses</Text>
          ...
          <View style={[styles.detailRow, { borderBottomWidth: 0 }]}>
            ...
            <View style={styles.detailInfo}>
              <Text style={styles.detailLabel}>Bergabung Sejak</Text>
        ...
        <Text style={styles.footerNote}>Sistem Verifikasi Pengaduan &copy; 2026</Text>
      </ScrollView>
    </SafeAreaView>
  );
}
