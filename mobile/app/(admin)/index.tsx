      ...
      <View style={styles.container}>
        ...
        <View style={styles.welcomeBanner}>
          <View>
            ...
            <Text style={styles.greetingSub}>Verifikasi dan tinjau semua aduan masuk dari masyarakat</Text>
          </View>
        ...
        <View style={styles.statsRow}>
          <View style={[styles.statCard, { borderLeftColor: '#2563EB' }]}>
            ...
            <Text style={styles.statLabel}>Semua Aduan</Text>
          </View>
        ...
        <View style={styles.searchContainer}>
          <View style={styles.searchWrapper}>
            ...
            <TextInput
              ...
              placeholder="Cari judul laporan masyarakat..."
            ...
            />
            {search.length > 0 && (
              <TouchableOpacity onPress={() => { setSearch(''); setTimeout(() => fetchAdminData(true), 50); }}>
        ...
        {isLoading ? (
          <View style={styles.loadingContainer}>
            ...
            <Text style={styles.loadingText}>Memuat aduan masyarakat...</Text>
          </View>
        ) : (
          <FlatList
            data={reports}
