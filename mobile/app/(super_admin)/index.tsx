...
export default function SuperAdminDashboard() {
  ...
  const fetchSuperAdminData = useCallback(async (showLoader = false) => {
    ...
    try {
      // 1. Fetch reports list with search/status filters
      ...
      console.error('Failed to load super admin dashboard data:', e);
    } finally {
      setIsLoading(false);
    ...
    return (
      ...
      >
        ...
        <View style={styles.cardHeader}>
          ...
          <Text style={styles.categoryText}>{item.category?.name || 'Kategori'}</Text>
        </View>
        ...
        <View style={styles.cardFooter}>
          <View style={styles.userInfo}>
            <Ionicons name="person-circle-outline" size={16} color="#64748B" style={styles.footerIcon} />
            <Text style={styles.usernameText} numberOfLines={1}>
              Oleh: <Text style={{ fontWeight: '700', color: '#475569' }}>{item.user?.username || 'Anonim'}</Text>
            </Text>
          </View>
    ...
    <SafeAreaView style={styles.safeContainer}>
      <View style={styles.container}>
        ...
        <View style={styles.welcomeBanner}>
          <View>
            <Text style={styles.greeting}>Dashboard Super Admin</Text>
            <Text style={styles.greetingSub}>Sistem kontrol aduan masyarakat tingkat instansi</Text>
          </View>
          <View style={styles.adminIndicator}>
            <Ionicons name="git-network" size={20} color="#6366F1" />
            <Text style={styles.adminIndicatorText}>Super Admin</Text>
          </View>
        </View>
        ...
        <View style={styles.statsRow}>
          <View style={[styles.statCard, { borderLeftColor: '#2563EB' }]}>
            ...
            <Text style={styles.statLabel}>Total Aduan</Text>
          </View>
        ...
        <View style={styles.searchContainer}>
          <View style={styles.searchWrapper}>
            ...
            <TextInput
              ...
              placeholder="Cari aduan masyarakat..."
            ...
            />
            {search.length > 0 && (
              <TouchableOpacity onPress={() => { setSearch(''); setTimeout(() => fetchSuperAdminData(true), 50); }}>
        ...
        {isLoading ? (
          <View style={styles.loadingContainer}>
            ...
            <Text style={styles.loadingText}>Memuat semua aduan...</Text>
          </View>
        ) : (
          <FlatList
            data={reports}
            ...
            ListEmptyComponent={
              <View style={styles.emptyContainer}>
                ...
                <Text style={styles.emptyTitle}>Tidak Ada Aduan</Text>
                <Text style={styles.emptyDesc}>
                  Belum ada aduan masyarakat yang sesuai dengan filter/pencarian ini.
                </Text>
              </View>
            }
          />
