    ...
    <SafeAreaView style={styles.safeContainer}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerSubtitle}>Kelola akun dan pengaturan profil Anda</Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.detailRow}>
            ...
            <View style={styles.detailInfo}>
              <Text style={styles.detailLabel}>Hak Akses (Role)</Text>
        ...
        <Text style={styles.footerNote}>Pengaduan Masyarakat Mobile App &copy; 2026</Text>
      </ScrollView>
    </SafeAreaView>
  );
}
